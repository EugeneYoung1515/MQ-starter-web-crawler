...
public class SimpleRedisMQAutoConfiguration {
    ...
    public LettuceConnectionFactory lettuceConnectionFactory(){
        ...
        lettuceConnectionFactory.setHostName(simpleRedisProperties.getHost());
        String password = simpleRedisProperties.getPassword();
        if(password!=null&&!password.isEmpty()) {
            lettuceConnectionFactory.setPassword(password);
        }
        lettuceConnectionFactory.setPort(simpleRedisProperties.getPort());
